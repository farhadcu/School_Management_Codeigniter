<?php
	...
	$this->set_js($this->default_theme_path.'/school/js/datatables.js');
	$this->set_js($this->default_theme_path.'/school/extras/TableTools/media/js/ZeroClipboard.js');
	$this->set_js($this->default_theme_path.'/school/extras/TableTools/media/js/TableTools.min.js');
...
<script type='text/javascript'>
	...
	var fivE 	= "<?=$this->l('five')?>";
	var teN 	= "<?php echo $this->l('ten'); ?>";
	var fifteeN 	= "<?php echo $this->l('fifteen'); ?>";
	var twentY 	= "<?php echo $this->l('twenty'); ?>";
	var twentyfiVe 	= "<?php echo $this->l('twenty_five'); ?>";
	var fiftY 	= "<?php echo $this->l('fifty'); ?>";
	var hundreD 	= "<?php echo $this->l('hundred'); ?>";
	var alL 	= "<?php echo $this->l('all'); ?>";
	<?php
