                ...
                <table class="table" >
					...
					<tbody>
						<tr>
							...
							<td>								
									<?php for ($m=1; $m<=12; $m++)
									{
										...
										?>
									<span class="payment_month_section"><input type="checkbox" name="payment_month[]" value="<?=$month?>" class="input" style="padding:0 !important;margin:0 !important;width: 10px;" required=""/>
									<?php
									echo $month."</span>";
									if($m==6)
									echo "<br>";
						...
						<tr>
							...
							<td><input type="text" name="invoice_number" id="invoice_name" value="<?php echo $inv_id;?>"/></td>
                            <td>Invoice Name</td>
							<td>
				...
				<table class="table table-normal box tablesorter" >
					...
					<tbody>
						...
						foreach ($query_result->result() as $item ):
							...
							if($due>0)
							{
								$collection="<input type='text' name='collection_amount_".$fees_name_id."' class='collection' max_value='".$due."' number value='0'>";
							}
							if($due<0)
							{
								$collection="Over Due-".abs($due);
							}
							if($fee_name):
							if($fees_amount):
							$fsl++;
                        ...
                        <tr>
							...
							<td>
								<input type='text' name='weaver_<?=$fees_name_id?>' class='weaver'  number>
							</td>
							<td>
