            ...
            <div class="accordion" id="accordion2">
                <div class="accordion-group">
                    <div class="accordion-heading">
							<a class="accordion-toggle" href="<?php echo base_url();?>index.php?/progress_card/progress_card_details_3/<?php echo $student_id.'/'.$row0['exam_id'].'/'.$class_id; ?>"  window="new" win_height="816px" win_width="1200px">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th width="37%" class="left-text">Subject </th>
													 <th width="7%">Fullmarks</th>
                                                    <th width="7%">Written: </th>
                                                    <th width="7%">Obje: </th>
                                                    <th width="7%">Prac: </th>
													<th width="7%">SBA</th>
                                                    <th width="7%">Total </th>
                                                ...
                                                foreach ($subjects as $row2):
                                                    ...
                                                    <tr>
                                                        ...
                                                        foreach ($marks as $row3):
                                                            ...
                                                            $total_marks = $row3['formation'] + $row3['objective'] + $row3['practical']+$row3['sba'];
															echo '<td>' .$row3['sba']. '</td>';
                                                            echo '<td>' . $total_marks . '</td>';
                                                            $total_marks_all_sub+=$total_marks;
															$orginal_total_mark_all+=$row3['total_marks'];
                                                            $verify_data = array('exam_id' => $row0['exam_id'],
                                                                'subject_id' => $row2['subject_id']);
                                                            ...
                                                            foreach ($marks as $row4):
                                                                $markstolal[$i] = $row4['formation'] + $row4['objective'] + $row4['practical']+$row4['sba'];
                                                                $i++;
                                                            endforeach;
                                                            /* print_r($markstolal);
                                                              exit; */
                                                         ...
                                                         //   $total+=$total_marks;
															$make_gpa = ($row3['sub_total'] / $row3['total_marks'])*100;
															
                                                            echo '<td>' . $this->crud_model->get_grade_from_gpa($make_gpa) . '</td>';

                                                            $total_grade_point += $this->crud_model->get_grade_point($make_gpa);
                                                    ...
                                                    <td colspan="5" style="padding: 0 3px 3px 3px;">
                                                        <table width="100%" style="text-align:right;">
                                                            ...
                                                            <tr>
                                                                <td>Grade</td>
                                                                <td><?php
                                                            $make_gpa = ($total_marks_all_sub/ $orginal_total_mark_all)*100;
                                                            echo  $this->crud_model->get_grade_from_gpa($make_gpa);
                                                ?></td>
                                                            </tr>
