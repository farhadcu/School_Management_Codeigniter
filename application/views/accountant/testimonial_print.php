		...
		<ul class="nav nav-tabs nav-tabs-left">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					<?php echo translate('Print testimonial');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------->
										...
										<td>
                                                 ...
                                                 <input type="checkbox" class="testimonial" name="testimonial[]" value="<?php echo $testimonial['testimonial_id'];?>"/> 
                                                       ...
                                                       <button class="btn btn-gray btn-normal dropdown-toggle" data-toggle="dropdown">
                                                        ...
                                                        <li> 
                                                            <a href="<?php echo base_url();?>index.php?admin/view_testimonial/<?php echo $testimonial['testimonial_id'];?>" window="new" win_height="816px" win_width="1200px" >
