                                    ...
                                    <select name="expense_by" class="expenseBy">
                                        ...
                                        <?php 
                                            foreach($expenses as $key => $value) { ?>
                                                <option value="<?php echo $value['expense_by']; ?>"  <?php if($this->session->userdata('expense_by') == $value['expense_by']) echo "selected"; ?>>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="expense_id" class="expenseID">
                                        ...
                                        <?php 
                                        foreach($expenses as $key => $value) { ?>
                                        <option value="<?php echo $value['expense_id']; ?>" <?php if($this->session->userdata('expense_id') == $value['expense_id']) echo "selected"; ?>><?php echo $value['expense_id']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="expense_name" class="expenseName">
                                        ...
                                        <?php 
                                            foreach($expenses as $key => $value) { ?>
                                                <option value="<?php echo $value['expense_name']; ?>" <?php if($this->session->userdata('expense_name') == $value['expense_name']) echo "selected"; ?>><?php echo $value['expense_name']; ?></option>
                                           <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="payment_to" class="paymentTo">
                                        ...
                                        <?php 
                                            foreach($expenses as $key => $value) { ?>
                                                <option value="<?php echo $value['payment_to']; ?>" <?php if($this->session->userdata('payment_to') == $value['payment_to']) echo "selected"; ?>><?php echo $value['payment_to']; ?></option>
                                           <?php } ?>
                                    </select>
                                </div>
                            </div>
                    ...
                    <tr>
                        <td>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input style="width: 220px;" type="text" class="datepicker fill-up" name="expense_date_from" value="<?php echo $this->session->userdata('expense_date_from'); ?>"/>
                                </div>
                            </div>
                        </td>
                        <td>    
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input style="width: 220px;" type="text" class="datepicker fill-up" name="expense_date_to" value="<?php echo $this->session->userdata('expense_date_to'); ?>"/>
                                </div>
                            </div>
                        </td>
                    </tr>
