                        ...
                        <td>
                            <div class="control-group">
                                <label class="control-label"><?php echo translate('student'); ?></label>
                                   <select name="student_id"  class="chzn-select">
                                    ...
                                    foreach ($students as $row):
                                        ?>
                                        <option class="student_<?php echo $row['class_id']; ?>" value="<?php echo $row['student_id']; ?>"  <?php if ($_POST['student_id'] == $row['student_id']) echo 'selected'; ?>>
